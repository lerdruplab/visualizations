...
#  scale_size_continuous(range = c(1, 10)) +             # Adjust the range to control the size of the points for only one plot
  ...
  scale_color_gradient2(low = "blue", mid = "white", high = "brown", midpoint = 0, limits = c(-2, 2)) #Limit sets the top and bottom, but values that falls outside this catrgory will be grey
